      ...
      >
        ...
        <div className="mx-auto flex h-25 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded border border-emerald-200 bg-white px-4 py-2 text-sm font-semibold text-emerald-900 hover:bg-emerald-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
                >
                <IconImg src={tiger} /> Schedule a Tour
            </Link>
          </div>
